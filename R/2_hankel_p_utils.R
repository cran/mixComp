...
#' @title Estimate a Mixture's Complexity (and Component Weights/Parameters) Based on Hankel Matrix
#'
...
#' @param mixture logical indicating whether the estimated mixture density should be drawn, set to \code{TRUE} by default.
#' @param components logical indicating whether the individual mixture components should be drawn, set to \code{TRUE} by default.
#' @param ylim range of y values to use; if not specified (or containing \code{NA}), the function tries to construct reasonable default values itself.
#' @param cex.main The magnification to be used for main titles relative to the current setting of \code{cex}, see \code{\link[graphics]{par}}.
#' @param \dots
#'    \describe{
