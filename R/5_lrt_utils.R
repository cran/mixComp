...
#' @title Estimate a Mixture's Complexity Based on Likelihood Ratio Test Statistics
#'
#' @description Estimation of a mixture's the complexity as well as its component weights and parameters based on comparing the likelihood ratio test statistic (LRTS) to a bootstrapped quantile.
#'
