...
#' @title Estimate a Continuous Mixture's Complexity Based on Hellinger Distance
#'
#' @description Estimation of a continuous mixture's complexity as well as its component weights and parameters by minimizing the squared Hellinger distance to a kernel density estimate.
#'
